...
public class Tracer 
{
    ...
    public Tracer(int x, int y, TileMap mRef)
    {
        ...
        buildGraph();   // invoke this and use mapRef to
    ...
    /// Problem 4 - Lab 3 Special Integration Activity
    //////////////////////////////////////////////
    /// Given any map with starting point from 1,1, carry out
    /// Breadth-First Search Algorithm to construct a graph
    /// from the existing map using mapRef[y-coord][x-coord]
    /// 
    /// Directed: Only move top-down and left-right
    /// Implication: Only search for the neighbouring intersections in 
